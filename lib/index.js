...
/***/ function(module, exports, __webpack_require__) {
	...
	_store2.default.Collection = _collection2.default;
	...
	var Store = function () {
	    ...
	    _createClass(Store, [{
	        ...
	        value: function dispatch(action) {
	            ...
	            this.queue(function () {
	                var _loop = function _loop(name) {
	                    ...
	                    if (collection instanceof _collection2.default) {
	                        (function () {
	                            var oldState = collection.state;
	                            Promise.resolve(collection.reducers[action.type](oldState, action)).then(function () {
	                                var newState = arguments.length <= 0 || arguments[0] === undefined ? oldState : arguments[0];
	                                ...
	                                if (newState !== oldState) {
	                                    ...
	                                    try {
	                                        for (var _iterator2 = collection.observers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                                            ...
	                                            observer(Object.assign(_this.state, _defineProperty({}, name, newState)), action, name);
	                                        }
	                                    } catch (err) {
	        ...
	        value: function observe(collectionNames, observer) {
	            collectionNames = (0, _utils.ensureArray)(collectionNames);
	            var _iteratorNormalCompletion3 = true;
	            var _didIteratorError3 = false;
	            var _iteratorError3 = undefined;

	            try {
	                for (var _iterator3 = collectionNames[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	var Collection = function () {
	    ...
	    _createClass(Collection, [{
	        ...
	        value: function on(types, reducer) {
	            types = (0, _utils.ensureArray)(types);
	            var _iteratorNormalCompletion = true;
	            var _didIteratorError = false;
	            var _iteratorError = undefined;
...
/***/ function(module, exports) {
	...
	var ensureArray = exports.ensureArray = function ensureArray(array) {
